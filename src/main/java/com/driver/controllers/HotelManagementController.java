...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        String ans = hotelmanagementservice.addHotel(hotel);
        return ans;
        // return null;
    }

    @PostMapping("/add-user") //2
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        int a = hotelmanagementservice.bookARoom(booking);
        return a;
    }

    @GetMapping("/get-bookings-by-a-person/{aadharCard}") //5
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        //In this function return the bookings done by a person
        int ans =   hotelmanagementservice.getBookings(aadharCard);
        return ans;
    }

    @PutMapping("/update-facilities") //6
